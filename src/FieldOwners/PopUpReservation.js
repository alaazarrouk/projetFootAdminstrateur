...
const PopUpReservation = ({ _id, name, address, state, type, price }) => {
  ...
  useEffect(async () => {
    console.log("id field :", field._id);
    if (choice == "All") {
      console.log("im in all  :");
      await axios
        .get(`/get/reservations/all/field/${field._id}`)
        .then((response) => {
      ...
      console.log(newDate);
      await axios
        .get(`/get/reservations/field/${field._id}/${newDate}`)
        .then((response) => {
          console.log(response.data);
          setReservations(response.data);
        });
  ...
  const cancelReservation = async (_id, date, time) => {
    ...
    if (result) {
      await axios
        ...
        .then((response) => {
          console.log(response.data);
          toast.info(`reservation with date ${_id} deleted successfully`, {
